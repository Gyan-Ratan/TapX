...
export const DesktopNavbar = ({ navItems }: Props) => {
  ...
  return (
    <motion.div
      className={cn(
        "w-full flex relative justify-between px-4 py-1 rounded-lg  transition duration-200 bg-transparent mx-auto"
      )}
      animate={{
    ...
    >
      ...
      <div className="flex space-x-2 items-center">
        <Button variant="simple" as={Link} href="https://app.tapxcard.io/">
          Register
        </Button>
        <Button as={Link} href="https://app.tapxcard.io/">
          Get Started
        </Button>
      </div>
    </motion.div>
